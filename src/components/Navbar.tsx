  ...
  return (
    ...
    >
      <div className="pointer-events-auto bg-white/10 backdrop-blur-md border border-white/5 rounded-[2rem] px-5 py-2.5 flex items-center justify-center shadow-lg">
        <span className="font-season-sans text-white text-2xl leading-none tracking-[0.15em]">flip</span>
      </div>
      ...
      <button className="pointer-events-auto bg-white text-black rounded-[2rem] px-6 py-3 font-inter font-bold text-[13px] hover:scale-105 transition-transform shadow-lg">
        Get Started
      </button>
    </motion.nav>
  );
