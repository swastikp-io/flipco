      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <div className="bg-poch-black border border-poch-white/20 p-8 md:p-12 rounded-[2rem] shadow-sm">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <button type="submit" className="w-full bg-flip-blue text-white px-8 py-4 rounded-xl font-inter font-bold text-lg hover:scale-[1.02] transition-transform mt-4 flex items-center justify-center gap-2">
